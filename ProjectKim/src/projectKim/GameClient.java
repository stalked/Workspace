...
public class GameClient {
	...
	public String loginEvent(int playerID) throws Exception {
		...
		System.out.println(reply + " [ loginEvent: UDPClient.java]");
		/* End of UDP protocol */
	...
	public void mapUpdateEvent(int playerID) throws Exception {
		...
		// Convert reply to string and print to System.out
		String reply = new String(incomingPacket.getData(), 0, incomingPacket.getLength());
		System.out.println(reply + " [ mapUpdateEvent: UDPClient.java]");
	...
	public int openTreasureEvent(int playerID) throws Exception {
		...
		// convert reply to string and print to System.out
		String reply = new String(incomingPacket.getData(), 0, incomingPacket.getLength());
		System.out.println(reply + " [ openTreasureEvent: UDPClient.java]");
		/* End of UDP protocol */
